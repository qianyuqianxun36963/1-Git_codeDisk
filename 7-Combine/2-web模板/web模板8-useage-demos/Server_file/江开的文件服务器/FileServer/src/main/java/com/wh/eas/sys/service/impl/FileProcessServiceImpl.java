...
public class FileProcessServiceImpl implements FileProcessService {
	...
	@Override
	public Map<String, Object> getFileNameByInfo(String fileName,
			String fileSize, String lastModifyTime, String fileUploadType,
			String uploadUserId) {
	...
	@Override
	public Boolean deleteFileByInfo(String fileName, String fileSize,
		...
		return this.fileprocessMapper.deleteFileByInfo(paramMap) > 0 ? Boolean.TRUE
				: Boolean.FALSE;
	}

	@Override
	public Boolean addFileByInfo(String fileName, String fileSize,
			String lastModifyTime, String fileUploadType, String uploadUserId,
		...
		return this.fileprocessMapper.addFileByInfo(paramMap) > 0 ? Boolean.TRUE
				: Boolean.FALSE;
	}
