...
function MoveDiv(obj,e){
	...
	//停止
	function endMov(e){
		//document.getElementById("ContentDetail").style.marginLeft=e.screenX-300+"px";
		//document.getElementById("CatalogDetail").style.width=e.screenX-320+"px";

		document.getElementById("ContentDetail").style.marginLeft=e.clientX+"px";
		document.getElementById("CatalogDetail").style.width=e.clientX-20+"px";
