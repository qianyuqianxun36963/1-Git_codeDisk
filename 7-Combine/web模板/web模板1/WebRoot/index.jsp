  ...
  <body>
    ...
    <div id="FunctionArea" class="defaultleftframe" style="min-height:500px;">
		<div class="defaultleftarea">      
			<iframe class="iframearea" src="Module/views/functionTree.html" name="Area" id="Area"  frameborder="0"></iframe>
		</div>
		<div class="defaultleftarea defaultleftareatail">
			<iframe class="iframearea" src="Module/views/commonTree.html" name="Tree" id="Tree" frameborder="0"></iframe>
		</div>
	</div>
	
	<div class="defaultrightframe">
		<div class="defaultrightarea">
			<iframe class="iframearea" src="Module/views/detailPages/detailPartment.jsp" name="Detail" id="Detail" frameborder="0" style="padding:0px;"></iframe>
		</div>
	</div>
