...
//公共静态变量
TreeGrid.FOLDER_OPEN_ICON = "../images/functionArea/folderOpen.gif";
TreeGrid.FOLDER_CLOSE_ICON = "../images/functionArea/folderClose.gif";
TreeGrid.DEFAULT_LEAF_ICON = "../images/functionArea/defaultLeaf.gif";
TreeGrid.COUNT = 1;
