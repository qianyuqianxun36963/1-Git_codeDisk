...
public class Vertex {
	...
	//辅助方法:判断顶点所在图的类型
	private boolean isUnDiGraphNode(){ return graphType==I_Graph.UndirectedGraph;}
	...
	//取顶点在所属图顶点集中的位置
	public I_Node getVexPosition(){ return vexPosition;}
