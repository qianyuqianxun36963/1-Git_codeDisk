...
public class Edge {
	...
	private I_Node edgePosition;		//边在边表中的位置
	private I_Node firstVexPosition;	//边的第一顶点与第二顶点
	private I_Node secondVexPosition;	//在顶点表中的位置
	private I_Node edgeFirstPosition;	//边在第一（二）顶点的邻接（逆邻接）边表中的位置
	private I_Node egdeSecondPosition;//在无向图中就是在两个顶点的邻接表中的位置
